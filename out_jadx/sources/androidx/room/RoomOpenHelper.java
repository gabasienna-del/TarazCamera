...
public class RoomOpenHelper extends SupportSQLiteOpenHelper.Callback {
    ...
    @Override // androidx.sqlite.db.SupportSQLiteOpenHelper.Callback
    public void onCreate(SupportSQLiteDatabase db) throws IOException, SQLException {
        Intrinsics.checkNotNullParameter(db, "db");
    ...
    @Override // androidx.sqlite.db.SupportSQLiteOpenHelper.Callback
    public void onOpen(SupportSQLiteDatabase db) throws IOException, SQLException {
        Intrinsics.checkNotNullParameter(db, "db");
        super.onOpen(db);
        checkIdentity(db);
    ...
    private final void checkIdentity(SupportSQLiteDatabase db) throws IOException, SQLException {
        String string;
