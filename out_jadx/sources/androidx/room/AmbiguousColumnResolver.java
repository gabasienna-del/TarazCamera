...
public final class AmbiguousColumnResolver {
    ...
    private final void rabinKarpSearch(List<ResultColumn> content, String[] pattern, Function3<? super Integer, ? super Integer, ? super List<ResultColumn>, Unit> onHashMatch) {
        ...
        for (String it : pattern) {
            iHashCode += it.hashCode();
        }
        int mappingHash = iHashCode;
        int startIndex = 0;
        ...
        public static final class Companion {
            ...
            public final Solution build(List<Match> matches) {
                ...
                for (Match it : matches) {
                    last += ((it.getResultRange().getLast() - it.getResultRange().getFirst()) + 1) - it.getResultIndices().size();
                }
                int coverageOffset = last;
                ...
                int last2 = it6.getResultRange().getLast();
                while (it5.hasNext()) {
                    Match it7 = (Match) it5.next();
                    int last3 = it7.getResultRange().getLast();
                    if (last2 < last3) {
                        last2 = last3;
                    }
                }
