...
public final class FtsTableInfo {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final FtsTableInfo read(SupportSQLiteDatabase database, String tableName) throws IOException {
        ...
        private final Set<String> readOptions(SupportSQLiteDatabase database, String tableName) throws IOException {
            ...
            try {
                ...
                if (cursor2.moveToFirst()) {
                    string = cursor2.getString(cursor2.getColumnIndexOrThrow("sql"));
                } else {
                    string = "";
                }
                CloseableKt.closeFinally(cursor, null);
