...
public final class TableInfoKt {
    public static final TableInfo readTableInfo(SupportSQLiteDatabase database, String tableName) throws IOException {
    ...
    private static final Set<TableInfo.ForeignKey> readForeignKeys(SupportSQLiteDatabase database, String tableName) throws IOException {
        Throwable th;
        List myColumns;
        List refColumns;
        int $i$f$useCursor;
    ...
    private static final Map<String, TableInfo.Column> readColumns(SupportSQLiteDatabase database, String tableName) throws IOException {
        Throwable th;
        String str = "type";
        String str2 = "name";
    ...
    private static final Set<TableInfo.Index> readIndices(SupportSQLiteDatabase database, String tableName) throws IOException {
        Throwable th;
    ...
    private static final TableInfo.Index readIndex(SupportSQLiteDatabase database, String name, boolean unique) throws IOException {
        Throwable th;
