...
public final class ListenableFutureKt$await$2$1 implements Runnable {
    ...
    public final void run() {
        try {
            ...
            continuation.resumeWith(Result.m181constructorimpl(this.$this_await.get()));
            ...
            if (!(throwable instanceof CancellationException)) {
                ...
                continuation2.resumeWith(Result.m181constructorimpl(ResultKt.createFailure(cause)));
                return;
            }
