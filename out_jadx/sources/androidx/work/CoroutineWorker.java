...
public abstract class CoroutineWorker extends ListenableWorker {
    ...
    static final class C00331 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return CoroutineWorker.this.new C00331(continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    try {
                        c00331.label = 1;
                        objDoWork = CoroutineWorker.this.doWork(c00331);
                    } catch (Throwable th) {
                        t = th;
                        c003312 = c00331;
    ...
    public final ListenableFuture<ListenableWorker.Result> startWork() {
        ...
        BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00331(null), 3, null);
        return this.future;
    }
