    ...
    */
    private void load(android.content.Context r11, org.xmlpull.v1.XmlPullParser r12) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L24:
            ...
            r4 = 0
            r5 = 0
            int r6 = r12.getEventType()     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
        L2b:
            r7 = 1
            if (r6 == r7) goto Lbc
        ...
        L33:
            goto Lb5
        L35:
            java.lang.String r7 = r12.getName()     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            boolean r7 = r8.equals(r7)     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            if (r7 == 0) goto L40
            return
        L40:
            r3 = 0
            goto Lb5
        L43:
            java.lang.String r9 = r12.getName()     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            r3 = r9
            int r9 = r3.hashCode()     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            switch(r9) {
                ...
                default: goto L4f;
            }     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
        L4f:
            goto L75
        L50:
            java.lang.String r7 = "Variant"
            boolean r7 = r3.equals(r7)     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            if (r7 == 0) goto L4f
            r7 = 3
            goto L76
        L5a:
            boolean r8 = r3.equals(r8)     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            if (r8 == 0) goto L4f
            goto L76
        L61:
        ...
        L79:
            ...
            goto L97
        L7c:
            androidx.constraintlayout.widget.StateSet$Variant r7 = new androidx.constraintlayout.widget.StateSet$Variant     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            r7.<init>(r11, r12)     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            if (r5 == 0) goto Lae
            r5.add(r7)     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            goto Lae
        L87:
            androidx.constraintlayout.widget.StateSet$State r7 = new androidx.constraintlayout.widget.StateSet$State     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            r7.<init>(r11, r12)     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            r5 = r7
            android.util.SparseArray<androidx.constraintlayout.widget.StateSet$State> r7 = r10.mStateList     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            int r8 = r5.mId     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            r7.put(r8, r5)     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            goto Lae
        L95:
            goto Lae
        L96:
            goto Lae
        L97:
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            r8.<init>()     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            java.lang.String r9 = "unknown tag "
            java.lang.StringBuilder r8 = r8.append(r9)     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            java.lang.StringBuilder r8 = r8.append(r3)     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            java.lang.String r8 = r8.toString()     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            android.util.Log.v(r7, r8)     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
        Lae:
            goto Lb5
        Laf:
            java.lang.String r7 = r12.getName()     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            r4 = r7
        Lb5:
            int r7 = r12.next()     // Catch: java.io.IOException -> Lbd org.xmlpull.v1.XmlPullParserException -> Lc2
            r6 = r7
            goto L2b
        Lbc:
            goto Lc6
