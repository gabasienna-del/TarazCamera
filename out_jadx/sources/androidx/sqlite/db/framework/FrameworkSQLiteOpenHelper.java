...
public final class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
        ...
        this.lazyDelegate = LazyKt.lazy(new Function0<OpenHelper>() { // from class: androidx.sqlite.db.framework.FrameworkSQLiteOpenHelper$lazyDelegate$1
            ...
            public final FrameworkSQLiteOpenHelper.OpenHelper invoke() {
                ...
                if (this.this$0.name != null && this.this$0.useNoBackupDirectory) {
                    File file = new File(SupportSQLiteCompat.Api21Impl.getNoBackupFilesDir(this.this$0.context), this.this$0.name);
                    openHelper = new FrameworkSQLiteOpenHelper.OpenHelper(this.this$0.context, file.getAbsolutePath(), new FrameworkSQLiteOpenHelper.DBRefHolder(null), this.this$0.callback, this.this$0.allowDataLossOnRecovery);
                } else {
    ...
    public /* synthetic */ FrameworkSQLiteOpenHelper(Context context, String str, SupportSQLiteOpenHelper.Callback callback, boolean z, boolean z2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(context, str, callback, z3, z4);
    }
        ...
        private final SQLiteDatabase innerGetDatabase(boolean writable) throws Throwable {
            ...
            try {
                ...
                try {
                    ...
                    } else if (!(openRetryError instanceof SQLiteException) || name == null || !this.allowDataLossOnRecovery) {
