...
public final class FlowExtKt {
    ...
    static final class AnonymousClass1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        static final class C00001 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C00001(Flow<? extends T> flow, ProducerScope<? super T> producerScope, Continuation<? super C00001> continuation) {
                super(2, continuation);
                this.$this_flowWithLifecycle = flow;
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (RepeatOnLifecycleKt.repeatOnLifecycle(this.$lifecycle, this.$minActiveState, new C00001(this.$this_flowWithLifecycle, $this$callbackFlow2, null), this) != coroutine_suspended) {
