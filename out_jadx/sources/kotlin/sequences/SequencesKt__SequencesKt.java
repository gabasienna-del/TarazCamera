...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00511<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C00511(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C00511> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00511 c00511 = new C00511(this.$this_ifEmpty, this.$defaultValue, continuation);
            c00511.L$0 = obj;
            return c00511;
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00511(sequence, defaultValue, null));
    }
    ...
    static final class C00521<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00521(Sequence<? extends T> sequence, Random random, Continuation<? super C00521> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00521 c00521 = new C00521(this.$this_shuffled, this.$random, continuation);
            c00521.L$0 = obj;
            return c00521;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C00521) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00521 = this;
                    sequenceScope = (SequenceScope) c00521.L$0;
                    mutableList = SequencesKt.toMutableList(c00521.$this_shuffled);
                    break;
                case 1:
                    c00521 = this;
                    mutableList = (List) c00521.L$1;
                    sequenceScope = (SequenceScope) c00521.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00521.$random.nextInt(mutableList.size());
                ...
                c00521.L$0 = sequenceScope;
                c00521.L$1 = mutableList;
                c00521.label = 1;
                if (sequenceScope.yield(t, c00521) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C00521(sequence, random, null));
    }
    ...
    static final class C00471<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00471(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C00471> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00471 c00471 = new C00471(this.$source, this.$transform, this.$iterator, continuation);
            c00471.L$0 = obj;
            return c00471;
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c00471 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c00471.L$0;
                    $this$sequence = $this$sequence2;
                    index = 0;
                    it = c00471.$source.iterator();
                    break;
                case 1:
                    c00471 = this;
                    index = c00471.I$0;
                    it = (Iterator) c00471.L$1;
                    $this$sequence = (SequenceScope) c00471.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            while (it.hasNext()) {
                ...
                Function2<Integer, T, C> function2 = c00471.$transform;
                int index2 = index + 1;
                if (index < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object result = function2.invoke(Boxing.boxInt(index), element);
                c00471.L$0 = $this$sequence;
                c00471.L$1 = it;
                c00471.I$0 = index2;
                c00471.label = 1;
                if ($this$sequence.yieldAll(c00471.$iterator.invoke(result), c00471) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                index = index2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C00471(source, transform, iterator, null));
    }
