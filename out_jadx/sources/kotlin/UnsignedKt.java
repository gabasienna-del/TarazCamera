...
public final class UnsignedKt {
    ...
    public static final long m534ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m355constructorimpl(Long.compare(v1 ^ Long.MIN_VALUE, v2 ^ Long.MIN_VALUE) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
        ...
        return ULong.m355constructorimpl((Long.compare(ULong.m355constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m355constructorimpl(v2) ^ Long.MIN_VALUE) < 0 ? 0 : 1) + quotient);
    }
    ...
    public static final long m535ulongRemaindereb3DHEI(long v1, long v2) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compare(ULong.m355constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m355constructorimpl(v2) ^ Long.MIN_VALUE) >= 0) {
            j = v2;
        }
