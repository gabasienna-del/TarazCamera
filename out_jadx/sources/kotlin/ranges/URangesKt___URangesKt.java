...
public class URangesKt___URangesKt {
    ...
    public static final UIntRange m1449untilJ1ME1BU(int $this$until_u2dJ1ME1BU, int to) {
        return Integer.compare(to ^ Integer.MIN_VALUE, 0 ^ Integer.MIN_VALUE) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange($this$until_u2dJ1ME1BU, UInt.m276constructorimpl(to - 1), null);
    }

    /* renamed from: until-eb3DHEI, reason: not valid java name */
    public static final ULongRange m1451untileb3DHEI(long $this$until_u2deb3DHEI, long to) {
        return Long.compare(to ^ Long.MIN_VALUE, 0 ^ Long.MIN_VALUE) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange($this$until_u2deb3DHEI, ULong.m355constructorimpl(to - ULong.m355constructorimpl(1 & 4294967295L)), null);
    }
