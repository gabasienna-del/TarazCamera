...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m401toStringimpl(this.first)).append("..").append((Object) ULong.m401toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m401toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m401toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
