...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1647boximpl(m1641markNowz9LOYto());
    }
    ...
    public long m1641markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1650constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1640elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1639differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1638adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1650constructorimpl(LongSaturatedMathKt.m1636saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
