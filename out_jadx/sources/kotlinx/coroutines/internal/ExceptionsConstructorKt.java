...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM181constructorimpl = Result.m181constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM181constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    objM181constructorimpl = Result.m181constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM181constructorimpl = Result.m181constructorimpl(ResultKt.createFailure(th));
                }
                return (Throwable) (Result.m187isFailureimpl(objM181constructorimpl) ? null : objM181constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM181constructorimpl = Result.m181constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM181constructorimpl = Result.m181constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m187isFailureimpl(objM181constructorimpl)) {
            objM181constructorimpl = numValueOf;
        }
        return ((Number) objM181constructorimpl).intValue();
    }
