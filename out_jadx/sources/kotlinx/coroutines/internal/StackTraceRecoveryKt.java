...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM181constructorimpl = Result.m181constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM181constructorimpl = Result.m181constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m184exceptionOrNullimpl(objM181constructorimpl) == null) {
            obj2 = objM181constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM181constructorimpl2 = Result.m181constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM181constructorimpl2 = Result.m181constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m184exceptionOrNullimpl(objM181constructorimpl2) == null) {
            obj = objM181constructorimpl2;
        }
