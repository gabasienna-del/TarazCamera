...
final /* synthetic */ class FlowKt__DelayKt {
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c01222 = this;
                    CoroutineScope $this$scopedFlow = (CoroutineScope) c01222.L$0;
                    FlowCollector downstream2 = (FlowCollector) c01222.L$1;
                    ReceiveChannel values2 = ProduceKt.produce$default($this$scopedFlow, null, -1, new FlowKt__DelayKt$sample$2$values$1(c01222.$this_sample, null), 1, null);
                    Ref.ObjectRef lastValue2 = new Ref.ObjectRef();
                    ticker = FlowKt__DelayKt.fixedPeriodTicker$default($this$scopedFlow, c01222.$periodMillis, 0L, 2, null);
                ...
                case 1:
                    c01222 = this;
                    ticker = (ReceiveChannel) c01222.L$3;
                    lastValue = (Ref.ObjectRef) c01222.L$2;
                    values = (ReceiveChannel) c01222.L$1;
                    downstream = (FlowCollector) c01222.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
            ...
            while (lastValue.element != NullSurrogateKt.DONE) {
                SelectImplementation $this$select_u24lambda_u241$iv = new SelectImplementation(c01222.get$context());
                ...
                c01222.L$0 = downstream;
                c01222.L$1 = values;
                c01222.L$2 = lastValue;
                c01222.L$3 = ticker;
                c01222.label = 1;
                if ($this$select_u24lambda_u241$iv.doSelect(c01222) == coroutine_suspended) {
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long periodMillis) {
        if (periodMillis > 0) {
            return FlowCoroutineKt.scopedFlow(new C01222(periodMillis, flow, null));
        }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope $this$fixedPeriodTicker, long delayMillis, long initialDelayMillis) {
        ...
        return ProduceKt.produce$default($this$fixedPeriodTicker, null, 0, new C01213(initialDelayMillis, delayMillis, null), 1, null);
    }
