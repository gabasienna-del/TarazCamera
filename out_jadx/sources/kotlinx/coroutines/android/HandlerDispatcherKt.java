...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM181constructorimpl = Result.m181constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM181constructorimpl = Result.m181constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m187isFailureimpl(objM181constructorimpl) ? null : objM181constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo1739dispatch(cont.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
