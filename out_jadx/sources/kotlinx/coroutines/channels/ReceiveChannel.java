...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1688tryReceivePtdJZtk = receiveChannel.mo1688tryReceivePtdJZtk();
            if (ChannelResult.m1703isSuccessimpl(objMo1688tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1699getOrThrowimpl(objMo1688tryReceivePtdJZtk);
            }
            Throwable thM1697exceptionOrNullimpl = ChannelResult.m1697exceptionOrNullimpl(objMo1688tryReceivePtdJZtk);
            if (thM1697exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1697exceptionOrNullimpl);
        }
