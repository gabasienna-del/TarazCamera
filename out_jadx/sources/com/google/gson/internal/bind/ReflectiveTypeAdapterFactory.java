...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private FieldsData getBoundFields(Gson context, TypeToken<?> type, Class<?> raw, boolean blockInaccessible, boolean isRecord) throws JsonIOException, SecurityException {
    ...
    private static final class RecordAdapter<T> extends Adapter<T, Object[]> {
        ...
        RecordAdapter(Class<T> raw, FieldsData fieldsData, boolean blockInaccessible) throws JsonIOException, SecurityException {
            super(fieldsData);
