...
public final class C0146SegmentedByteString extends ByteString {
    ...
    public C0146SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        return new C0146SegmentedByteString(newSegments$iv, newDirectory$iv);
    }
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        C0146SegmentedByteString $this$commonWrite$iv;
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        C0146SegmentedByteString $this$commonWrite$iv2 = this;
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        C0146SegmentedByteString $this$commonRangeEquals$iv = this;
        ...
        while (pos$iv$iv < endIndex$iv$iv) {
            ...
            C0146SegmentedByteString $this$commonRangeEquals$iv2 = $this$commonRangeEquals$iv;
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        ...
        C0146SegmentedByteString $this$commonCopyInto$iv = this;
