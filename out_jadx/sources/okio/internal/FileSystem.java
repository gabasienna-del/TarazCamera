...
public final class FileSystem {
    ...
    static final class C01481 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        C01481(Path path, okio.FileSystem fileSystem, boolean z, Continuation<? super C01481> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01481 c01481 = new C01481(this.$dir, this.$this_commonListRecursively, this.$followSymlinks, continuation);
            c01481.L$0 = obj;
            return c01481;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C01481) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c01481 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c01481.L$0;
                    ArrayDeque stack2 = new ArrayDeque();
                    stack2.addLast(c01481.$dir);
                    $this$sequence = $this$sequence2;
                    stack = stack2;
                    it = c01481.$this_commonListRecursively.list(c01481.$dir).iterator();
                    break;
                case 1:
                    c01481 = this;
                    it = (Iterator) c01481.L$2;
                    ArrayDeque stack3 = (ArrayDeque) c01481.L$1;
                    SequenceScope $this$sequence3 = (SequenceScope) c01481.L$0;
                    ResultKt.throwOnFailure($result);
                    stack = stack3;
            ...
            while (it.hasNext()) {
                Path next = it.next();
                c01481.L$0 = $this$sequence;
                c01481.L$1 = stack;
                c01481.L$2 = it;
                c01481.label = 1;
                if (FileSystem.collectRecursively($this$sequence, c01481.$this_commonListRecursively, stack, next, c01481.$followSymlinks, false, c01481) == coroutine_suspended) {
    ...
    public static final Sequence<Path> commonListRecursively(okio.FileSystem $this$commonListRecursively, Path dir, boolean followSymlinks) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(dir, "dir");
        return SequencesKt.sequence(new C01481(dir, $this$commonListRecursively, followSymlinks, null));
    }
